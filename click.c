...
//compte le nombres de cases similaires à cells( dans notre cas EMPTY)
    int count=0;
...
//va changer la grille selon qui a gagné
...
//va mettre la croix et le rond selon l'endroit où le joueur a cliqué
